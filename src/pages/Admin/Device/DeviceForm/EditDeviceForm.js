...
const NewDeviceForm = props => {
  ...
  const submitNewDeviceHandler = event => {
    ...
    let requestBody = {
      query: `
        mutation EditDevice($secretKey: String!, $name: String!, $location: String!, $tdsWanted: Float!, $phWanted: Float!, $floodInterval: Float!, $floodDuration: Float!, $startFloodTime: String!, $endFloodTime: String!,  $startLedTime: String!, $endLedTime: String! ) {
          editDevice(deviceInput:{secretKey: $secretKey, name: $name, location: $location, tdsWanted: $tdsWanted, phWanted: $phWanted, startLedTime: $startLedTime, floodInterval: $floodInterval, floodDuration: $floodDuration, startFloodTime: $startFloodTime, endFloodTime: $endFloodTime, endLedTime: $endLedTime}) {
            name
            createdAt
            location
            tdsWanted
      ...
      <GridContainer>
        <GridItem xs={12} sm={12} md={12}>
          <TextField
            ...
            label="Secret Key (Disabled)"
            id="secrect-key"
            fullWidth
            value={props.data.secretKey}
            disabled
        ...
        <GridItem xs={12} sm={12} md={3}>
          <TextField
            ...
            fullWidth
            required
            defaultValue={props.data.info[0]}
            inputRef={nameEl}
          />
        </GridItem>
        <GridItem xs={12} sm={12} md={9}>
          <TextField
            ...
            fullWidth
            required
            defaultValue={props.data.info[2]}
            inputRef={locationEl}
          />
        </GridItem>
        <GridItem xs={12} sm={12} md={6}>
          <TextField
            ...
            id="tdsWanted"
            type="number"
            defaultValue={props.data.info[3]}
            inputProps={{
              step: 1,
              min: 400,
              max: 1500
        ...
        <GridItem xs={12} sm={12} md={6}>
          <TextField
            ...
            label="pH Wanted"
            id="phWanted"
            defaultValue={props.data.info[4]}
            type="number"
            inputProps={{
              step: 0.1,
              min: 5,
        ...
        <GridItem xs={12} sm={12} md={6}>
          <TextField
            ...
            id="floodInterval"
            type="number"
            defaultValue={props.data.info[5]}
            inputProps={{
              step: 0.1,
              min: 0
            }}
        ...
        <GridItem xs={12} sm={12} md={6}>
          <TextField
            ...
            id="floodDuration"
            type="number"
            defaultValue={props.data.info[6]}
            inputProps={{
              step: 0.1,
              min: 0
            }}
        ...
        <GridItem xs={12} sm={12} md={6}>
          <TextField
            ...
            id="startFloodTime"
            type="time"
            defaultValue={props.data.info[7]}
            fullWidth
            required
        ...
        <GridItem xs={12} sm={12} md={6}>
          <TextField
            ...
            id="endFloodTime"
            type="time"
            defaultValue={props.data.info[8]}
            fullWidth
            required
        ...
        <GridItem xs={12} sm={12} md={6}>
          <TextField
            ...
            id="startLedTime"
            type="time"
            defaultValue={props.data.info[9]}
            fullWidth
            required
        ...
        <GridItem xs={12} sm={12} md={6}>
          <TextField
            ...
            id="endtLedTime"
            type="time"
            defaultValue={props.data.info[10]}
            fullWidth
            required
